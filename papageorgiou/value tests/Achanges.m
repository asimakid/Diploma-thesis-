...
figure(1)
title("Norm of Acceleration of cars for different A values for q " +num2str(q))
xlabel("Time in sec")
ylabel("Accel in m/s^2")
legend(instr(Avalues))
figure(2)
title("Lyap func values for different A values for q " + num2str(q))
xlabel("Time in sec")
legend(instr(Avalues))
figure(3)
title("Norm of Acceleration of cars for different A values for q "+ num2str(q))
