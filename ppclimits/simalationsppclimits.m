...
x0(4*(j-1)+1) = [1,2,3,7,10,15,18,24,30,32]*5; %init xi
x0(4*(j-1)+2) = [-6.5,+5,-2,-1,-3,4,-2.5,3,+3,-4]*0.8; %init yi
x0(4*(j-1)+3) = [0.02,-0.05,0.01,0.03,-0.04,+0.01,0,0.05,-0.01,0]*4; %init thetai
x0(4*(j-1)+4) = [18,28,30,27,25,29,25,34,31,27]*1; %init vi
%{
x0(4*(j-1)+1) = [1,2,3,7,10,15,18,24,30,32]*10; %init xi
x0(4*(j-1)+2) = [-6.5,+5,+3,-1,-3,4,-2.5,3,+3,-4]*0.8; %init yi
x0(4*(j-1)+3) = [0.01,-0.01,0.02,0.01,-0.01,+0.01,0.005,0.001,-0.01,-0.05]*4; %init thetai
x0(4*(j-1)+4) = [18,28,30,27,25,29,25,34,31,32]*1; %init vi
%}
%{
x0(4*(j-1)+1) = [1,2,3,7,10,15,18,22,30,35]*7; %init xi
x0(4*(j-1)+2) = [-6.5,+6.5,0,-5,-3,+3,-1.5,3,+1,0]*0.8; %init yi
x0(4*(j-1)+3) = [0.01,-0.01,0.02,0.01,-0.01,+0.01,0.005,0.001,-0.01,-0.02]*10; %init thetai
x0(4*(j-1)+4) = [20,28,30,27,25,34,25,32,31,25]*1; %init vi
%}
